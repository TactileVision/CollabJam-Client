...
import { TactonPlaybackActionTypes } from "@/feature/collabJamming/store/tactonPlayback/tactonPlayback";
import { TactonMutations, TactonSettingsActionTypes } from "@/feature/collabJamming/store/tactonSettings/tactonSettings";
            ...
            switch (rm) {
                ...
                case InteractionMode.Playback:
                    ...
                    if (update.tactonId != undefined) {
                        store.dispatch(TactonPlaybackActionTypes.selectTacton, update.tactonId)
