 ...
 */
export async function pingDisplayViaIPC(deviceUuid: string, durationMs: number) {
 ...
 */
export function writeAmplitudeOnDisplay(deviceUuid: string, channels: number[], amplitude: number) {
...
export function writeFrequencyOnDisplay(deviceUuid: string, channels: number[], frequency: number) {
