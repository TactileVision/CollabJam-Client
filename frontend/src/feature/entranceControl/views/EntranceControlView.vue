<template>
	...
	<v-row>
		<v-col cols="8">
			<v-radio-group :disabled="actuators.length < 2" v-model="userCurrentStep" inline>
		...
		<v-col>
			<actuator-selection-menu :disabled="isRunning" :numActuators="2" v-model="actuators"></actuator-selection-menu>
		</v-col>
