...
import DefaultProfile from "@/feature/collabJamming/views/playGroundComponents/UserMenu/DefaultProfile.vue";
import CustomProfile from "@/feature/collabJamming/views/playGroundComponents/UserMenu/CustomProfile.vue";
