...
<script lang="ts">
import getDeviceName from "@/core/Input/InputDetection/getDeviceName";
import { useStore } from "@/app/store/store";
import { InputDevice } from "@/core/Input/InputDetection/types/InputBindings";
import { defineComponent } from "@vue/runtime-core";
import defaultImagePath from "@/feature/collabJamming/assets/controller.svg";
import { PlayGroundMutations } from "@/feature/collabJamming/store/playGround/types";
import { StateProfile } from "@/feature/collabJamming/store/playGround/playGround";
